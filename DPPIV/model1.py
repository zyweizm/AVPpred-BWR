...
def ourmodel_1mer(input_shape=(30, 150), head_size=128, num_heads=4, ff_dim=512, dropout=0.2, num_layers=3):
...
def ourmodel_4mer(input_shape=(73, 150), head_size=100, num_heads=4, ff_dim=512, dropout=0.2, num_layers=3):
    inputs = Input(shape=input_shape)
